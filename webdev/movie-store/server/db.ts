  ...
  users: [
    {
      ...
      pwd: 'joão',
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJuYW1lIjoiSm_Do28ifQ.Kl7eecd1CmgtcGtFtJSUPI9ayGc97814zSNfwf51hDs',
    },
    {
      id: 2,
      name: 'vicente',
      pwd: 'vicente',
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjIiLCJuYW1lIjoiVmljZW50ZSJ9.tPtEs82krECraV7JVdiCNKRV53i3gWuEmXzZzYok7C4',
    },
    {
      id: 3,
      name: 'diogo',
      pwd: 'diogo',
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjMiLCJuYW1lIjoiRGlvZ28ifQ.8PYRRoK0pnt2TTqp6HoZzrGWOeqfbkXfp4an_DecYYs',
    },
    {
      id: 4,
      name: 'sara',
      pwd: 'sara',
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQiLCJuYW1lIjoiU2FyYSJ9.rYA1SgP1x5l75k2C66ia0vZKi3egPgEQgisnRfdhJCE',
    },
    {
      id: 5,
      name: 'joana',
      pwd: 'joana',
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjUiLCJuYW1lIjoiSm9hbmEifQ.OF2eptBuf-YfyDcW5ryp982-qtE9xK-pRJtvRClaXBk',
    },
  ],
  genres: [
    'Comedy',
